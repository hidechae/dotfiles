...
"
let phpmanual_dir             = '/home/shi-nakamura/.vim/doc/php_manual/'
...
if exists("g:phpmanual_use_ext_browser") && g:phpmanual_use_ext_browser == 1
  ...
  if !exists("g:phpmanual_ext_mapname")
    ...
    let g:phpmanual_ext_mapname = "<Leader>M"
  endif
...
if !exists('g:phpmanual_dir')
  ...
  let g:phpmanual_dir      = "/home/gree/dic/"
